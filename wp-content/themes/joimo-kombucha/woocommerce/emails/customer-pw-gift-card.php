...
<style type="text/css">
    ...
    #pwgc-email-gift-card-container {
        ...
        background-image: url('https://joimotea.com/wp-content/uploads/2022/09/gift.jpg');
        border: none;
    }
...
<table id="pwgc-email-gift-card-container" height="275" width="100%">
    ...
    <tr>
        ...
        <td>
            ...
            <div id="pwgc-email-amount" style="color: #fff;"><?php echo wc_price( $item_data->amount, $item_data->wc_price_args ); ?></div>
        </td>
        <td width="10"></td>
    </tr>
    <tr>
