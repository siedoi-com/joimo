	...
	<div id="top_hero_section" class="hero-box container-fluid"> <!-- Container for page title and hero -->		
		...
		<div class="hero-row skinny row newsletter">
			...
			<section class="newsletter-container">
				...
				?>  
				<aside id="social-subscribe" class="widget-area widget-area--subscribe">
				...
				<div class="hero-row skinny row split-image-section desktop-split-image-section">
					...
					<section class="headline-column col-md-4 col-4">
						...
						<div class="split-image">
							...
							<img class="mobile_img_block" src="<?php the_field('split_3_column_group_1_split_image_mobile'); ?>">
						</div>
					...
					<section class="hero-column col-md-4 col-4">	            					
						<div class="split-image">
							...
							<img class="mobile_img_block" src="<?php the_field('split_3_column_group_2_split_image_mobile'); ?>">
						</div>
					...
					<section class="headline-column col-md-4 col-4">
						...
						<div class="split-image">
							...
							<img class="mobile_img_block" src="<?php the_field('split_3_column_group_3_split_image_mobile'); ?>">
						</div>
