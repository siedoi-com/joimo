...
?>
	...
	<div class="home-slider-container container-fluid">
	
	<section class="post-slider row">
	
		<div class="post-slider-container col-md-12">
	
			<?php the_field('slideshow_container'); ?>
