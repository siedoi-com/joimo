 ...
 *
 * Template Name: Column Block Style Page
...
?>	
    ...
    <div class="custom_post_template custom_post_alternate_style_template custom_post_column_style_template">
			<!-----START TITLE ---------->
            <div class="our-story__container blog-heading">
            <div class="blog-heading__authror">
                <!-- Hide avatar for video post -->
      ...
      <div class="single-container container"> <!-- Begin single container -->
          ...
          <div id="primary-row" class="content-area row">
            <main id="primary" class="site-main col-md-12 col-sm-12 hentry category-explore-recipes-stories" role="main">
...
.mejs-overlay-button{
    width: 100%;
    background: url(https://joimotea.com/wp-content/uploads/2021/08/Button.png);
